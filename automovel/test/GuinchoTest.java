...
public class GuinchoTest {
    ...
    private Automovel moto1 = new Moto(200);
    private Automovel moto2 = new Moto(150);
    private Automovel moto3 = new Moto(100);
    private Automovel moto4 = new Moto(180);

    private Automovel carro1 = new Carro(200);
    private Automovel carro2 = new Carro(280);
